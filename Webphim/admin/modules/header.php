					...
					<div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle me-3"
						...
						<ul class="navbar-nav flex-nowrap ms-auto">
							...
							<!-- sau khi đã đăng nhập -->
                                <li class="nav-item dropdown no-arrow">
                                    <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link" 
                                            aria-expanded="false" data-bs-toggle="dropdown" href="#"><span 
                                                class="d-none d-lg-inline me-2 text-gray-600 small"><?php  if (isset($_SESSION['login'])) {echo $_SESSION['login'];}?></span><img
                                        ...
                                        <div class="dropdown-menu shadow dropdown-menu-end animated--grow-in"><a
                                                ...
                                                log</a>
                                            <div class="dropdown-divider"></div><a class="dropdown-item" href="index.php?logout=1"><i
                        ...
                        <!-- <ul class="navbar-nav flex-nowrap ms-auto">
                                ...
                                <div class="nav-item dropdown no-arrow">
                                    <a class="dropdown-toggle nav-link" id='login'>
                                    <button class="btn btn-primary" type="button" data-bs-toggle="modal">Đăng nhập</button>
                                </a>
                                </div>
                            </li>
                        </ul> -->
